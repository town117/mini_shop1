...
(1, 1, 2780, '2020-11-03 06:44:59', '已出貨');
...
(2, 'BRUNBJÖRN 填充玩具, 熊', '<p>這隻柔軟的泰迪熊喜歡每件事物和每個人，但是最重要的是它喜歡莓果，無論是藍色或紅色都喜歡；它是一位忠實朋友，喜歡擁抱，讓你感受更多的愛</p>\r\n', 139, 1, '2020-11-03 06:44:25'),
(3, '鱷魚拔牙齒', '<p>它不需要使用電池.它的牙齒機關是隨機的呦</p>\r\n', 70, 1, '2020-11-03 06:47:59');
...
(1, '小明', 'tor', '$2y$10$YYWqmeM0z49zdWSQps/lyuAwERGzcCoo6IJcgInFTVbEArS3KOVye', 'eric315117@gmail.com', '先生', '0999999999', '222', '新北市', '深坑區', '板橋區');
